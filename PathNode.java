...
public class PathNode implements Comparable {
	 ...
	 * @param path the path that will be stored
	 */
	 ...
	 * @param left the node that will be assigned as the left child
	 */
	 ...
	 * @param right the node that will be assigned as the right child
	 */
	 ...
	 * @param parent the node that will be assigned as the parent
	 */
	 ...
	 * @param generation the node that will be assigned to the right
	 */
	...
	/**
	 * Sets the current path node to be labeled as the 
	 * leftmost node in it's level
	 * @param isLevelEnd t/f that sets this path node to be the level end
	 */
	 ...
	 * @param isLastNode t/f that sets this path node to be the last node
	 */
